...
namespace Mirror
{
    ...
    public static class NetworkTime
    {
        ...
        //Additonal fields to maintain for TickManager.cs
        static ExponentialMovingAverage _fullRTToffset = new ExponentialMovingAverage(10);
        public static double clientTime => localTime - _fullRTToffset.Value;
        ...
        public static void ResetStatics()
        {
            ...
            _fullRTToffset = new ExponentialMovingAverage(PingWindowSize);
        ...
        internal static void OnClientPong(NetworkPongMessage message)
        {
            ...
            //Additional Logic for TickManager.cs
            _fullRTToffset.Add(now - newRtt - message.serverTime);
